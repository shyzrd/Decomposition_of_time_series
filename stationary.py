...
#读取数据
data = pd.read_csv("/Users/wangyankai/Desktop/data.csv")
#打印开头几个对象
print(data.head())
#显示数据类型
print('\n Data types:')
...
data = pd.read_csv("/Users/wangyankai/Desktop/data.csv", parse_dates=['datetime'], index_col='datetime',date_parser=dateparse)
print(data.head())
print(data.index)
